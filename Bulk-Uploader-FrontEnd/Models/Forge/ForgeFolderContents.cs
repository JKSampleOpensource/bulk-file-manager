...
namespace Bulk_Uploader_Electron.Models.Forge.FolderContents
{
    public class ForgeFolderItem {
        public Jsonapi jsonapi { get; set; }
        public Links links { get; set; }
        public FolderItemDatum data { get; set; }
    }
    ...
    public class ForgeFolderContents
    {
        ...
        public Links links { get; set; }
        public FolderItemDatum[] data { get; set; }
        public FolderItemIncluded[] included { get; set; }
    }
    ...
    public class FolderItemIncluded
    {
        public string type { get; set; }
        public string id { get; set; }
